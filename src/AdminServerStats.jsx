...
const AdminServerStats = () => {
    ...
    useEffect(() => {
        ...
        const dedicatedServers = serverData.servers.filter(s => 
            s.server_alias?.toLowerCase().includes('dedicated') || 
            s.server_ip?.toLowerCase().includes('dedicated')
        );
        const sharedServers = serverData.servers.filter(s => 
            !s.server_alias?.toLowerCase().includes('dedicated') && 
            !s.server_ip?.toLowerCase().includes('dedicated')
        );
    ...
    const filteredServers = serverData?.servers?.filter(server => {
        const searchLower = serverSearchTerm.toLowerCase();
        const aliasMatch = server.server_alias?.toLowerCase().includes(searchLower);
    ...
    const getMetrics = () => {
        ...
        const avgBotsPerServer = serverData.total_servers > 0
                    ...
                    <>
                        <div style={{
                            ...
                            <div style={{
                                ...
                                <p style={{ margin: "0 0 8px 0", fontSize: "12px", color: "#6b7280", fontWeight: "600", textTransform: "uppercase" }}>
                                    Total Servers
                                </p>
                                    ...
                                    <table style={{
                                        ...
                                        <thead>
                                            <tr style={{ backgroundColor: "#f9fafb", borderBottom: "2px solid #e5e7eb" }}>
                                                <th style={{ padding: "12px 16px", textAlign: "left", fontWeight: "600", color: "#374151", width: "30px" }}>
                                                </th>
                                        ...
                                        <tbody>
                                            {/* Dedicated Servers */}
                                            {filteredServers
                                                .filter(s => s.server_alias?.toLowerCase().includes('dedicated') || s.server_ip?.toLowerCase().includes('dedicated'))
                                                .map((server, idx) => (
                                                    <React.Fragment key={server.server_id}>
                                                        <tr
                                                            style={{
                                                                borderBottom: expandedServerId === server.server_id ? "none" : "1px solid #e5e7eb",
                                                        ...
                                                        >
                                                            <td style={{ padding: "12px 16px", textAlign: "center" }}>
                                                                <span style={{
                                                                    ...
                                                                    transform: expandedServerId === server.server_id ? "rotate(90deg)" : "rotate(0deg)"
                                                                }}>
                                                                    ▶
                                                                </span>
                                                            </td>
                                                            ...
                                                            <td style={{ padding: "12px 16px", textAlign: "center" }}>
                                                                <div style={{
                                                                    ...
                                                                    <div style={{
                                                                        ...
                                                                        backgroundColor: server.active_bots > server.total_bots * 0.8 ? "#ef4444" : server.active_bots > server.total_bots * 0.5 ? "#f59e0b" : "#10b981",
                                                                        height: "100%",
                                                                        borderRadius: "4px"
                                                                    }}></div>
                                                                </div>
                                                                <div style={{ fontSize: "11px", color: "#6b7280", marginTop: "4px" }}>
                                                                    {server.total_bots > 0 ? Math.round(server.active_bots / server.total_bots * 100) : 0}%
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        {/* Expanded Campaign Details */}
                                                        {expandedServerId === server.server_id && server.campaigns && server.campaigns.length > 0 && (
                                                                ...
                                                                <td colSpan="8" style={{ padding: 0, backgroundColor: "#f9fafb" }}>
                                                                    <div style={{
                                                                        ...
                                                                        <div style={{
                                                                            ...
                                                                            Campaigns on this server ({server.campaigns.length})
                                                                        </div>
                                                                        <table style={{
                                                                            width: "100%",
                                                                            borderCollapse: "collapse",
                                                                            ...
                                                                            <thead>
                                                                                <tr style={{ backgroundColor: "#f3f4f6" }}>
                                                                                    <th style={{ padding: "10px 12px", textAlign: "left", fontWeight: "600", color: "#4b5563" }}>Campaign</th>
                                                                                    <th style={{ padding: "10px 12px", textAlign: "left", fontWeight: "600", color: "#4b5563" }}>Client</th>
                                                                                    <th style={{ padding: "10px 12px", textAlign: "center", fontWeight: "600", color: "#4b5563" }}>Model</th>
                                                                                    <th style={{ padding: "10px 12px", textAlign: "center", fontWeight: "600", color: "#4b5563" }}>Extension</th>
                                                                                    <th style={{ padding: "10px 12px", textAlign: "center", fontWeight: "600", color: "#4b5563" }}>Status</th>
                                                                                    <th style={{ padding: "10px 12px", textAlign: "center", fontWeight: "600", color: "#4b5563" }}>Active Bots</th>
                                                                                    <th style={{ padding: "10px 12px", textAlign: "center", fontWeight: "600", color: "#4b5563" }}>Total Bots</th>
                                                                                </tr>
                                                                            </thead>
                                                                            <tbody>
                                                                                {server.campaigns.map((campaign, cidx) => (
                                                                                    <tr
                                                                                        key={campaign.campaign_id}
                                                                                        style={{
                                                                                            borderBottom: cidx < server.campaigns.length - 1 ? "1px solid #e5e7eb" : "none"
                                                                                        }}
                                                                                    >
